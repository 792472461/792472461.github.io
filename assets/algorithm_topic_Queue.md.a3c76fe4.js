import{_ as n,c as s,o as a,d as p}from"./app.4fc031e0.js";const y='{"title":"\u961F\u5217\u7ECF\u5178\u95EE\u9898","description":"","frontmatter":{},"headers":[{"level":2,"title":"\u57FA\u4E8E\u94FE\u8868\u5B9E\u73B0\u7684\u961F\u5217","slug":"\u57FA\u4E8E\u94FE\u8868\u5B9E\u73B0\u7684\u961F\u5217"},{"level":2,"title":"234.\u6ED1\u52A8\u7A97\u53E3\u7684\u6700\u5927\u503C","slug":"_234-\u6ED1\u52A8\u7A97\u53E3\u7684\u6700\u5927\u503C"},{"level":2,"title":"622.\u8BBE\u8BA1\u53CC\u7AEF\u961F\u5217","slug":"_622-\u8BBE\u8BA1\u53CC\u7AEF\u961F\u5217"},{"level":2,"title":"641.\u8BBE\u8BA1\u5FAA\u73AF\u53CC\u7AEF\u961F\u5217","slug":"_641-\u8BBE\u8BA1\u5FAA\u73AF\u53CC\u7AEF\u961F\u5217"},{"level":2,"title":"859.\u4EB2\u5BC6\u5B57\u7B26\u4E32","slug":"_859-\u4EB2\u5BC6\u5B57\u7B26\u4E32"},{"level":2,"title":"860.\u67E0\u6AAC\u6C34\u627E\u96F6","slug":"_860-\u67E0\u6AAC\u6C34\u627E\u96F6"},{"level":2,"title":"933.\u6700\u8FD1\u8BF7\u6C42\u6B21\u6570","slug":"_933-\u6700\u8FD1\u8BF7\u6C42\u6B21\u6570"},{"level":2,"title":"969.\u714E\u997C\u6392\u5E8F","slug":"_969-\u714E\u997C\u6392\u5E8F"}],"relativePath":"algorithm/topic/Queue.md","lastUpdated":1641484540174}',t={},o=p(`<h1 id="\u961F\u5217\u7ECF\u5178\u95EE\u9898" tabindex="-1">\u961F\u5217\u7ECF\u5178\u95EE\u9898 <a class="header-anchor" href="#\u961F\u5217\u7ECF\u5178\u95EE\u9898" aria-hidden="true">#</a></h1><h2 id="\u57FA\u4E8E\u94FE\u8868\u5B9E\u73B0\u7684\u961F\u5217" tabindex="-1">\u57FA\u4E8E\u94FE\u8868\u5B9E\u73B0\u7684\u961F\u5217 <a class="header-anchor" href="#\u57FA\u4E8E\u94FE\u8868\u5B9E\u73B0\u7684\u961F\u5217" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token keyword">class</span> <span class="token class-name">Node</span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="_234-\u6ED1\u52A8\u7A97\u53E3\u7684\u6700\u5927\u503C" tabindex="-1">234.\u6ED1\u52A8\u7A97\u53E3\u7684\u6700\u5927\u503C <a class="header-anchor" href="#_234-\u6ED1\u52A8\u7A97\u53E3\u7684\u6700\u5927\u503C" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token comment">/**
 * @param {number[]} nums
 * @param {number} k
 * @return {number[]}
 */</span>
<span class="token keyword">const</span> <span class="token function-variable function">maxSlidingWindow</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">nums<span class="token punctuation">,</span> k</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">if</span> <span class="token punctuation">(</span>k <span class="token operator">===</span> <span class="token number">1</span><span class="token punctuation">)</span> <span class="token keyword">return</span> nums
    ...
    <span class="token comment">// 1. \u7EF4\u62A4\u4E00\u4E2A\u53CC\u7AEF\u961F\u5217\uFF0C\u4FDD\u8BC1\u91CC\u9762\u5143\u7D20\u5927\u5C0F\u662F\u9012\u51CF\u7684</span>
    <span class="token keyword">const</span> q <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Deque</span><span class="token punctuation">(</span>nums<span class="token punctuation">.</span>length<span class="token punctuation">)</span> <span class="token comment">// \u8FD9\u91CC\u9700\u8981\u5F15\u5165\u76F8\u5E94\u7684\u6570\u636E\u7ED3\u6784\uFF0C\u4E5F\u53EF\u4EE5\u7528\u6570\u7EC4\u4EE3\u66FF</span>
    <span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> nums<span class="token punctuation">.</span>length<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token comment">// \u53EA\u8981num[\u961F\u5C3E] &lt;= nums[i],\u5220\u9664\u961F\u5C3E</span>
      <span class="token keyword">while</span> <span class="token punctuation">(</span><span class="token operator">!</span>q<span class="token punctuation">.</span><span class="token function">isEmpty</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">&amp;&amp;</span> nums<span class="token punctuation">[</span>i<span class="token punctuation">]</span> <span class="token operator">&gt;</span> nums<span class="token punctuation">[</span>q<span class="token punctuation">.</span><span class="token function">getLast</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        q<span class="token punctuation">.</span><span class="token function">removeLast</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
      <span class="token punctuation">}</span>
      <span class="token comment">// \u5C06i\u52A0\u5230\u961F\u5C3E</span>
      q<span class="token punctuation">.</span><span class="token function">addLast</span><span class="token punctuation">(</span>i<span class="token punctuation">)</span>

      <span class="token comment">// \u68C0\u67E5w\u7D22\u5F15\u662F\u5426\u5408\u6CD5</span>
      <span class="token keyword">const</span> w <span class="token operator">=</span> i <span class="token operator">-</span> k <span class="token operator">+</span> <span class="token number">1</span>
      <span class="token keyword">if</span> <span class="token punctuation">(</span>w <span class="token operator">&lt;</span> <span class="token number">0</span><span class="token punctuation">)</span> <span class="token keyword">continue</span>

      <span class="token comment">// \u68C0\u67E5\u961F\u5934\u7684\u5408\u6CD5\u6027</span>
      <span class="token keyword">while</span> <span class="token punctuation">(</span>q<span class="token punctuation">.</span><span class="token function">getFront</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">&lt;</span> w<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">// \u961F\u5934\u4E0D\u5408\u6CD5</span>
        q<span class="token punctuation">.</span><span class="token function">removeFront</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
      <span class="token punctuation">}</span>
      ans<span class="token punctuation">[</span>w<span class="token punctuation">]</span> <span class="token operator">=</span> nums<span class="token punctuation">[</span>q<span class="token punctuation">.</span><span class="token function">getFront</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">]</span>
    <span class="token punctuation">}</span>
    <span class="token keyword">return</span> ans
  <span class="token punctuation">}</span>

console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">maxSlidingWindow</span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token operator">-</span><span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">5</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">6</span><span class="token punctuation">,</span> <span class="token number">7</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre></div><h2 id="_622-\u8BBE\u8BA1\u53CC\u7AEF\u961F\u5217" tabindex="-1">622.\u8BBE\u8BA1\u53CC\u7AEF\u961F\u5217 <a class="header-anchor" href="#_622-\u8BBE\u8BA1\u53CC\u7AEF\u961F\u5217" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token comment">/**
 ...
 */</span>
</code></pre></div><h2 id="_641-\u8BBE\u8BA1\u5FAA\u73AF\u53CC\u7AEF\u961F\u5217" tabindex="-1">641.\u8BBE\u8BA1\u5FAA\u73AF\u53CC\u7AEF\u961F\u5217 <a class="header-anchor" href="#_641-\u8BBE\u8BA1\u5FAA\u73AF\u53CC\u7AEF\u961F\u5217" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token comment">/*
...
</code></pre></div><h2 id="_859-\u4EB2\u5BC6\u5B57\u7B26\u4E32" tabindex="-1">859.\u4EB2\u5BC6\u5B57\u7B26\u4E32 <a class="header-anchor" href="#_859-\u4EB2\u5BC6\u5B57\u7B26\u4E32" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token comment">/*
...
<span class="token comment">// @lc code=end</span>
</code></pre></div><h2 id="_860-\u67E0\u6AAC\u6C34\u627E\u96F6" tabindex="-1">860.\u67E0\u6AAC\u6C34\u627E\u96F6 <a class="header-anchor" href="#_860-\u67E0\u6AAC\u6C34\u627E\u96F6" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token comment">/**
 * @param {number[]} bills
 * @return {boolean}
 */</span>
...
</code></pre></div><h2 id="_933-\u6700\u8FD1\u8BF7\u6C42\u6B21\u6570" tabindex="-1">933.\u6700\u8FD1\u8BF7\u6C42\u6B21\u6570 <a class="header-anchor" href="#_933-\u6700\u8FD1\u8BF7\u6C42\u6B21\u6570" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token comment">/*
...
</code></pre></div><h2 id="_969-\u714E\u997C\u6392\u5E8F" tabindex="-1">969.\u714E\u997C\u6392\u5E8F <a class="header-anchor" href="#_969-\u714E\u997C\u6392\u5E8F" aria-hidden="true">#</a></h2><div class="language-javascript"><pre><code><span class="token comment">/* eslint-disable no-unused-vars */</span>
<span class="token comment">/**
 * @param {number[]} arr
 * @return {number[]}
 */</span>
...
</code></pre></div>`,17),e=[o];function c(u,l,k,r,i,d){return a(),s("div",null,e)}var w=n(t,[["render",c]]);export{y as __pageData,w as default};
